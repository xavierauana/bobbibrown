...
Route::group(['middleware' => "auth"], function () {
    ...
    Route::get('/collections/{collection}/lessons/{lesson}',
        'HomeController@showCollectionLesson')->name("show.collection.lesson");

    Route::get('/lessons/{lesson}', 'HomeController@showLesson')
         ->name("show.lesson");
    ...
    Route::get('/myEvents', 'HomeController@showMyEvents')
         ->name('show.myevents');
    Route::post('/events/{event}/cancel', 'HomeController@cancelEvent')
         ->name('user.event.cancel');
    Route::post('/events/{event}/registration', 'HomeController@registration')
         ->name('user.event.registration');
    Route::get('/events/{event}/signin', 'HomeController@eventSignIn')
         ->name('signin.event');
    Route::post('/events/{event}/signin', 'HomeController@logSignIn')
         ->name('log.signin.event');
    Route::get('/events/{event}', 'HomeController@showEventDetail')
